...
import argparse
from motor_sim.gui.plot_style_editor import main as gui_main
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Open the MotorSim plot editor for a project directory.")
    parser.add_argument("--project", default=DEFAULT_PROJECT, help="Project directory containing plot.yaml and out/.")
